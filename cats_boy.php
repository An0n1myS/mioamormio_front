...
<head>
	...
	<link rel="stylesheet" href="css/Style-cats_boy.css">
	<title>Mio Amor Mio*Ua male-cat</title>
						...
						<div class="panel__open form-panel">
							...
							<ul class="form-panel__list">
								...
								<li>
									...
									<li>
										<a class="form-panel__link" href="profile.php" id="auth-btn"></a>
									</li>
									<li>
	...
	<div class="content">
		...
		<div class="wrapper">
			...
			<div class="page-title">
				<h1><i>
					Наши серебристые коты.
					<br>
					Не метящие коты-производители
				</i></h1>
			</div>
			...
			<div class="slider">
				...
				<div class="slider__item">
					<img src="img/Cats_old/basia.jpg" alt="#">
				</div>
				<div class="slider__item">
					<img src="img/Cats_old/emma.jpg" alt="#">
				</div>
				<div class="slider__item">
					<img src="img/Cats_old/Felicia.jpg" alt="#">
				</div>
				<div class="slider__item">
					<img src="img/Cats_old/Gerard.jpg" alt="#">
				</div>
				<div class="slider__item">
					<img src="img/Cats_old/Timmy.jpg" alt="#">
				</div>
			...
			<div class="page-text-1">
				...
				<img src="img/Cats_old/Timmy.jpg" class="img1">
				<div class="page-text-1_text">
					CH Champion WCF
					<br>
					Timmy Frostiness,CZ
					<br>
			...
			<div class="page-text-2">
				...
				<img src="img/Cats_old/Gerard.jpg" class="img2">
				<div class="page-text-2_text">
					Gr. I. Ch Grand International Champion WCF
					<br>
					Gerard Anirette
					<br>
					BRI, black silver shell
					<br>
					(ns 12)
				</div>
	...
	<form action="php/check.php" class="form-reg" id="form-reg" method="post">
		...
		<div class="form-reg__input">
			...
			<div class="form-reg__block">
				...
				<input type="text" class="form-reg__control" name="name" id="name" autocomplete="off" placeholder="  Введите имя">
			</div>
