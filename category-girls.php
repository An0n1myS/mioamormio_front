...
<head>
	...
	<link rel="stylesheet" href="css/Style-girls_galery.css">
						...
						<div class="panel__open form-panel">
							...
							<ul class="form-panel__list">
								...
								<li>
									...
									<li>
										<a class="form-panel__link" href="" id="auth-btn"></a>
									</li>
									<li>
				...
				<div class="categories">
					...
					<div class="categories__1 category">
						...
						<div class="page_title">
							<h1>Felicia Anirette</h1>
						</div>

						<div class="slider">

							<div class="slider__item">
								<img src="img/Felisia/1.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/2.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/3.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/4.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/5.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/6.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/7.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Felisia/8.png" alt="#">
							</div>
					...
					<div class="categories__2 category">
						...
						<div class="page_title">
							<h1>Amor Mio Olivia</h1>
						</div>

						<div class="slider">

							<div class="slider__item">
								<img src="img/album_Olivia/1.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/album_Olivia/2.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/album_Olivia/3.png" alt="#">
							</div>
					...
					<div class="categories__3 category">
						...
						<div class="page_title">
							<h1>Anno Domini Emilia-Snezhnoe Chudo</h1>
						</div>

						<div class="slider">

							<div class="slider__item">
								<img src="img/Emilia/1.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/2.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/3.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/4.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/5.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/6.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/7.png" alt="#">
							</div>
							<div class="slider__item">
								<img src="img/Emilia/8.png" alt="#">
							</div>
	...
	<form action="/php/check.php" class="form-reg" id="form-reg" method="post">
		...
		<div class="form-reg__input">
			...
			<div class="form-reg__block">
				...
				<input type="password" class="form-reg__control1" name="pass" autocomplete="off" id="pass" placeholder="Введите пароль">
