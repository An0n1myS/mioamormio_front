						...
						<div class="panel__open form-panel">
							...
							<ul class="form-panel__list">
								...
								<li>
									...
									<li>
										<a href="deleteProfile.php" class="form-panel__link" id="del-btn">Удалить аккаунт</a>
									</li>
									<li>
			...
			<div class="profile">
				...
				<form action="updateProfile.php" method="post">
					<ul class="info-view">
						...
						<li>
							<span>Имя пользователя:  </span> <input id="name" name="name" type="text">
						</li>
						<li>
							<span>Адрес электронной почты: </span> <input id="mail" name="mail" type="email">
						</li>
				...
				<div class="booking-table">
					<form action="updateUserByAdmin.php" method="post">
